  ...
  name.addEventListener("keyup", function (e) {
    if (e.keyCode == 13 && name.value != "") {
      ...
      if (command == "help") {
        ...
        + "new_index name - Creates an index with the specified name.<br>index name set attr value - Sets the value of the index attribute.<br>index name get attr - Gets the value of the index attribute.<br>show_index name - Displays the index as a map.<br>attach dst src - Attaches src index to dst.<br><br>"
        ...
        + "new_index name - Создает индекс с указанным именем.<br>index name set attr value - Устанавливает значение атрибута index.<br>index name get attr - Получает значение атрибута index.<br>show_index name - Отображает индекс в виде карты.<br>attach dst src - Прикрепляет индекс src к dst.<br><br>"

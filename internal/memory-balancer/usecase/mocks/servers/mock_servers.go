...
// Source: itisadb/internal/memory-balancer/usecase (interfaces: IServers)
...
import (
	context "context"
	servers "itisadb/internal/memory-balancer/servers"
	reflect "reflect"
...
func (m *MockIServers) GetServer() (*servers.Server, bool) {
	m.ctrl.T.Helper()
...
func (m *MockIServers) GetServerByID(arg0 int32) (*servers.Server, bool) {
	m.ctrl.T.Helper()
